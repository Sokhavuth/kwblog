            ...
            $.get("/paginate/backEnd", function(data, status){
              if((status=='success') && data.json){
                ...
                for(var index in posts){
                  ...
                  html += `<a class="post-thumb" target="_blank" href="/post/${posts[index][0]}"><img src="${thumbs[index]}" /></a>`;
                  ...
                  html += `<a href="/post/delete/${posts[index][0]}"><img title="Delete" class="delete" src="/static/images/delete.png" /></a>`;
                  html += `<a href="/post/edit/${posts[index][0]}"><img title="Edit" src="/static/images/edit.png" /></a>`;
                  html += '</div>';
                  html += '</div>';
                }
