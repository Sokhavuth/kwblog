...
<div  id='main' class='main region'>
  ...
  <section id='content' class='content'>
    ...
    <form action="/paging" method="post">
      %if 'edit' in data:
      <input id="post-title" name="fpost-title" value="{{data['post'][0][1]}}" type="text" placeholder="ចំណងជើង​ទំព័រ" required />
      ...
      %del data['edit']
      %else:
      <input id="post-title" name="fpost-title" type="text" placeholder="ចំណងជើង​ទំព័រ" required />
...
%include('./dashboard/partials/page-footer.tpl')