    ...
    <article class="post">
      ...
      <div class="post-author">
        ...
        <div class="icon-outer">
          <a class="edit-icon" href="/user/edit/{{data['post'][0][0]}}"><img src="/static/images/edit.png"/></a>
          <a class="delete-icon" href="/user/delete/{{data['post'][0][0]}}"><img src="/static/images/delete.png"/></a>
        </div>
        %del data['showEdit']
        %end
      </div>

      <div class="post-body">{{!data['post'][0][-2]}}</div>
      %end
...
%include('./partials/user-footer.tpl')